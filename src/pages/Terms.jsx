...
export default function Terms() {
  return (
    <PageShell title="Terms of Use">
      ...
      <p>NewsSphere is a news aggregation and AI journalism platform. We fetch headlines from publicly available RSS feeds, use AI to write original analytical summaries, and present them alongside a link to the original source. We do not reproduce original publisher content.</p>
      ...
      <ul>
        ...
        <li><strong>Images</strong> — article images are loaded from publisher CDNs via their own URLs. Copyright remains with the original publisher or photographer.</li>
      ...
      <h2>Accuracy</h2>
      <p>NewsSphere AI summaries are generated automatically. While we instruct the AI to be factual, we cannot guarantee accuracy. Always verify important information with the original source. NewsSphere is not liable for decisions made based on content displayed here.</p>

      <h2>Availability</h2>
      <p>We aim for continuous uptime but make no guarantees. The pipeline runs automatically but may be delayed due to third-party API limits or GitHub Actions scheduling.</p>
